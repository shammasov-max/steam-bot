...
const SharedLayout: React.FC<SharedLayoutProps> = ({ children }) => {
    ...
    const tabs = [
        { id: 'console', label: 'Console', href: '/console', badge: undefined },
        { id: 'accounts', label: 'Import accounts', href: '/accounts', badge: 5 },
        { id: 'proxy', label: 'Import proxy', href: '/proxy', badge: undefined },
        { id: 'friends', label: 'Friends', href: '/friends', badge: 12 },
        { id: 'settings', label: 'Settings', href: '/settings', badge: undefined },
        { id: 'actions', label: 'Actions', href: '/actions', badge: undefined },
        { id: 'faq', label: 'FAQ', href: '/faq', badge: undefined },
    ]
                            ...
                            <div className="flex items-center space-x-4 text-sm">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-green-400">
                                        {onlineAccountsCount} Online
                                    </span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <div className="w-2 h-2 bg-gray-400 rounded-full"></div>
                                    <span className="text-gray-400">
                                        {accountsCount - onlineAccountsCount} Offline
                                    </span>
                                </div>
                                <div className="text-gray-300">
                                    Total:{' '}
                                    <span className="text-white font-medium">{accountsCount}</span>
                                </div>
                            </div>
                        </div>
                    </div>
