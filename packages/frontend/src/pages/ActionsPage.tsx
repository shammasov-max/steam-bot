                            ...
                            <div className="flex-1">
                              ...
                              {activeAction === action.id && (
                                <div className="space-y-3 mt-4 pt-3 border-t border-steam-lightblue/30">
                                  ...
                                  {action.id === 'group-joiner' && (
                                    <div className="space-y-3">
                                      <div>
                                        <label className="block text-sm font-medium text-white mb-2">Group URLs (one per line)</label>
                                        <textarea
                                          placeholder="https://steamcommunity.com/groups/groupname1&#10;https://steamcommunity.com/groups/groupname2"
                                          className="input-field w-full h-20 resize-none"
                                        />
                                      </div>
                                      <div>
                                        <label className="block text-sm font-medium text-white mb-2">Join delay (seconds)</label>
                                        <input
                                          type="number"
                                          defaultValue={10}
                                          className="input-field w-24"
